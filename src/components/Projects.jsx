...
//                     <i className="bi bi-github me-2"></i> Voir sur GitHub </a>
              ...
              <div className="card h-100 border-0 shadow-sm">
                <div className="card-body p-4">
                  ...
                  <div className="project-links">
                    <a href={project.github} target="_blank" rel="noopener noreferrer" 
                      className="d-flex align-items-center text-primary jetbrains-mono-regular mb-2" > 
                      <i className="bi bi-github me-2"></i> Voir sur GitHub 
                    </a>
                    {project.title === "Site e-commerce complet" && (
                      <a href="https://test.icvinformatique.com/" target="_blank" rel="noopener noreferrer" 
                        className="d-flex align-items-center text-success jetbrains-mono-regular" > 
                        <i className="bi bi-globe me-2"></i> Voir le site 
                      </a>
                    )}
                  </div>
