  ...
  return (
    <section id="about" className="py-5">
      <div className="container">
        <h2 className="text-center gradient-text fw-bold mb-5 jetbrains-mono-bold">À propos de moi</h2>
        <div className="row justify-content-center">
          <div className="col-lg-8">
            <p className="lead text-white mb-4 jetbrains-mono-regular">
              Développeur Web et Web Mobile passionné par la création d'interfaces dynamiques, modernes et accessibles,
